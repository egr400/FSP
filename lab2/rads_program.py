...
# Sehyeon Oh
# Aaron Yanes
# Full Stack Python EGR 400
# January 31, 2020
import json
import os
import xml.etree.ElementTree as xmltree
from lab.rads_logger import Logger
import csv
...
class Program:
    def __init__(self):
        ...
        self.logger = Logger(os.path.join(self.data_folder, "michael-kennedy-blog.xml"))
    ...
    def load_xml(self):
        ...
        dom = xmltree.ElementTree("michael-kennedy-blog.xml")
        dom.parse(filename)
        root = dom.getroot()
    ...
    def load_csv(self):
        ...
        with open("fx-seven-day.csv", 'r') as csv_file:
    ...
    def build_currency_lookup(filename):
        ...
        with open(filename, "r") as fin:
            for line in fin:
                if line is None or line.strip().startswith('#') or line.startswith('Date'):
                    continue
