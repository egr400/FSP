...
#Similar to Lab3 Part 1, create a new folder named data. Then in the init_engine() method,
#insert the path to the newly created folder. Make sure that python interpreter is mapped
#to the correct project and contains appropriate libraries. After these steps the code
#should run without issue. The new database object will be created in the data folder.
